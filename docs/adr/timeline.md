# ADR Timeline
- [Efficient API Consumption via HTTP Conditional Requests (ETags)](001_github_etags.md)
- [Adaptive Rate-Limited Repository Scanner](002_scanner.md)
- [Use Redis Streams for Notification Message Queue](003_redis_streams_for_mq.md)
